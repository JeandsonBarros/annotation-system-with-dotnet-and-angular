...
# API Annotations System with .NET

API developed for annotations management. The API has the following functionality:
- Authentication
...
- Data Base MySql config:<br/>
  `"ConnectionStrings": {
    "DefaultConnection": "server=localhost;user=root;password='';database=Annotations;"
    }`
